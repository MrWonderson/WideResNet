...
tf.app.flags.DEFINE_float('gpu_memory_fraction', 0.5, '''Initial learning rate''')
...
tf.app.flags.DEFINE_integer('widen_factor', 2, '''Widen factor in WRN''')
...
tf.app.flags.DEFINE_string('test_ckpt_path', './logs_test_110/widen_factor_' + str(FLAGS.widen_factor) +'/model.ckpt-79999', '''Checkpoint
directory to restore''')


train_dir = 'logs_' + FLAGS.version + '/widen_factor_' + str(FLAGS.widen_factor) + '/'